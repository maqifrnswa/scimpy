...
Headphones output is low impedance output, like 10-100 ohms (typically are ~32 ohms). Use headphones as output to drive speakers

line out? does it have enough current? no, output impedance is like 100-600 ohms

So hook up - headphones output, line in input.

Line-level: consumer is 0.447 Vmax (0.894 Vpp)
