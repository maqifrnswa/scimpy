...
\begin{figure}
\centering
\includegraphics[scale=.6]{Speaker-cross-section.png}
...
WITH coupling to another speaker! another pressure source at same frequency in acoustic circuit. Maybe make out of phase (reverse polarity wiring) from original?

COMBINED impedance testing
